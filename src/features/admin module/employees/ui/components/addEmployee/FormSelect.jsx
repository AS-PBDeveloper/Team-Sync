  ...
  return (
    <div>
      ...
      <div className="relative">
        <select className="appearance-none w-full h-16 rounded-2xl border border-[var(--border-color)] bg-[var(--bg-main)] px-5 outline-none text-lg text-[var(--text-primary)]">
